\hypertarget{read__trajec_8c}{}\doxysection{src/trajec\+\_\+io/read\+\_\+trajec.c File Reference}
\label{read__trajec_8c}\index{src/trajec\_io/read\_trajec.c@{src/trajec\_io/read\_trajec.c}}
{\ttfamily \#include $<$stdio.\+h$>$}\newline
{\ttfamily \#include $<$stdlib.\+h$>$}\newline
{\ttfamily \#include $<$string.\+h$>$}\newline
{\ttfamily \#include \char`\"{}chemistry.\+h\char`\"{}}\newline
{\ttfamily \#include \char`\"{}read\+\_\+trajec.\+h\char`\"{}}\newline
Include dependency graph for read\+\_\+trajec.\+c\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{read__trajec_8c__incl}
\end{center}
\end{figure}
\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
int \mbox{\hyperlink{read__trajec_8c_a3c6d1f71e221b01cade9b0f92d4a0e50}{get\+\_\+atom\+\_\+and\+\_\+frame\+\_\+no}} (char $\ast$name, int $\ast$atom\+\_\+no, int $\ast$frame\+\_\+no)
\begin{DoxyCompactList}\small\item\em Counts number of atoms and frames in an xyz-\/file. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{read__trajec_8c_a28ba4e821d33b79b6a7b1f72cc944a42}{skipline}} (FILE $\ast$f)
\item 
int \mbox{\hyperlink{read__trajec_8c_af31f65142114a5aeed9d8e7db587d2d0}{readxyz}} (char $\ast$name, int $\ast$frame\+\_\+no\+\_\+pointer, int $\ast$atom\+\_\+no\+\_\+pointer, float $\ast$$\ast$trajectory\+\_\+pointer, int $\ast$$\ast$atom\+\_\+pointer)
\begin{DoxyCompactList}\small\item\em Reads content of an xyz-\/file into a 3D-\/array. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{read__trajec_8c_a682f8020235937bff5fafc167f699bb9}{readtraj}} (char $\ast$name, int $\ast$frame\+\_\+no\+\_\+pointer, int $\ast$atom\+\_\+no\+\_\+pointer, float $\ast$$\ast$trajectory\+\_\+pointer, int $\ast$$\ast$atom\+\_\+pointer)
\begin{DoxyCompactList}\small\item\em Reads content of an xyz-\/file or dat-\/file into a 3D-\/array. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{read__trajec_8c_a0a6bb87b70d1861153d70f671bd4117f}{readdat}} (char $\ast$datname, int $\ast$frame\+\_\+no\+\_\+pointer, int $\ast$atom\+\_\+no\+\_\+pointer, float $\ast$$\ast$trajectory\+\_\+pointer, int $\ast$$\ast$atom\+\_\+pointer)
\begin{DoxyCompactList}\small\item\em Reads content of an auxiliary dat-\/file into a 3D-\/array. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{read__trajec_8c_a80ae9d3db42cfd36c139612240d245e6}{readpbc}} (char $\ast$name, float pbc\mbox{[}3\mbox{]}\mbox{[}3\mbox{]})
...
int \mbox{\hyperlink{read__trajec_8c_a672f3802fe413e9f17beccee67d52292}{removecom}} (int frame\+\_\+no, int atom\+\_\+no, float traj\mbox{[}frame\+\_\+no\mbox{]}\mbox{[}atom\+\_\+no\mbox{]}\mbox{[}3\mbox{]}, int atom\mbox{[}atom\+\_\+no\mbox{]}, float trajcom\mbox{[}frame\+\_\+no\mbox{]}\mbox{[}atom\+\_\+no\mbox{]}\mbox{[}3\mbox{]})
\begin{DoxyCompactList}\small\item\em Removes center of mass movement from a trajectory. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{read__trajec_8c_a62cc15b7e5e2c932b48a4b5c1b47a4ee}{writexyz}} (char $\ast$name, int frame\+\_\+no, int atom\+\_\+no, float traj\mbox{[}frame\+\_\+no\mbox{]}\mbox{[}atom\+\_\+no\mbox{]}\mbox{[}3\mbox{]}, int atom\mbox{[}atom\+\_\+no\mbox{]})
...
\mbox{\Hypertarget{read__trajec_8c_a3c6d1f71e221b01cade9b0f92d4a0e50}\label{read__trajec_8c_a3c6d1f71e221b01cade9b0f92d4a0e50}} 
\index{read\_trajec.c@{read\_trajec.c}!get\_atom\_and\_frame\_no@{get\_atom\_and\_frame\_no}}
\index{get\_atom\_and\_frame\_no@{get\_atom\_and\_frame\_no}!read\_trajec.c@{read\_trajec.c}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{read__trajec_8c_a0a6bb87b70d1861153d70f671bd4117f}\label{read__trajec_8c_a0a6bb87b70d1861153d70f671bd4117f}} 
\index{read\_trajec.c@{read\_trajec.c}!readdat@{readdat}}
\index{readdat@{readdat}!read\_trajec.c@{read\_trajec.c}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{read__trajec_8c_a80ae9d3db42cfd36c139612240d245e6}\label{read__trajec_8c_a80ae9d3db42cfd36c139612240d245e6}} 
\index{read\_trajec.c@{read\_trajec.c}!readpbc@{readpbc}}
\index{readpbc@{readpbc}!read\_trajec.c@{read\_trajec.c}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{read__trajec_8c_a682f8020235937bff5fafc167f699bb9}\label{read__trajec_8c_a682f8020235937bff5fafc167f699bb9}} 
\index{read\_trajec.c@{read\_trajec.c}!readtraj@{readtraj}}
\index{readtraj@{readtraj}!read\_trajec.c@{read\_trajec.c}}
...
int 1 if a problem occured, otherwise 0. 
\end{DoxyReturn}
\mbox{\Hypertarget{read__trajec_8c_af31f65142114a5aeed9d8e7db587d2d0}\label{read__trajec_8c_af31f65142114a5aeed9d8e7db587d2d0}} 
\index{read\_trajec.c@{read\_trajec.c}!readxyz@{readxyz}}
\index{readxyz@{readxyz}!read\_trajec.c@{read\_trajec.c}}
...
int 1 if a problem occured, otherwise 0. 
\end{DoxyReturn}
\mbox{\Hypertarget{read__trajec_8c_a672f3802fe413e9f17beccee67d52292}\label{read__trajec_8c_a672f3802fe413e9f17beccee67d52292}} 
\index{read\_trajec.c@{read\_trajec.c}!removecom@{removecom}}
\index{removecom@{removecom}!read\_trajec.c@{read\_trajec.c}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{read__trajec_8c_a28ba4e821d33b79b6a7b1f72cc944a42}\label{read__trajec_8c_a28ba4e821d33b79b6a7b1f72cc944a42}} 
\index{read\_trajec.c@{read\_trajec.c}!skipline@{skipline}}
\index{skipline@{skipline}!read\_trajec.c@{read\_trajec.c}}
...
\mbox{\Hypertarget{read__trajec_8c_a62cc15b7e5e2c932b48a4b5c1b47a4ee}\label{read__trajec_8c_a62cc15b7e5e2c932b48a4b5c1b47a4ee}} 
\index{read\_trajec.c@{read\_trajec.c}!writexyz@{writexyz}}
\index{writexyz@{writexyz}!read\_trajec.c@{read\_trajec.c}}
